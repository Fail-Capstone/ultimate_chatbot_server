...
router.post("/patterns", verifyToken, async (req, res) => {
    ...
    try {
        ...
        console.log(updatedPatterns.patterns);
        console.log(pattern);
        pattern = [ "selectedQuestion", "datgavlabcksụldf" ]
        updatedPatterns.patterns = [...updatedPatterns.patterns, pattern];
        console.log(updatedPatterns.patterns);

        // updatedPatterns.patterns.concat(pattern);
        // console.log(updatedPatterns);
        // await updatedPatterns.save();
        // const { patterns } = updatedPatterns;
        // updatedPatterns = {
        //     ...updatedPatterns,
